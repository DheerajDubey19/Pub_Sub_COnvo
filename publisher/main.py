...
@app.post("/insert_user", response_model=Dict[str, str])
async def insert_user_endpoint(user: User) -> Dict[str, str]:
    try:
...
@app.post("/delete_user", response_model=Dict[str, str])
async def delete_user_endpoint() -> Dict[str, str]:
    try:
...
@app.post("/process_users", response_model=Dict[str, str])
async def process_users() -> Dict[str, str]:
    try:
